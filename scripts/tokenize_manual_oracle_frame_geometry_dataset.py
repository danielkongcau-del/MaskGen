...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Tokenize oracle-frame local geometry training sequences.")
...
def main() -> None:
    ...
    sequences_path = args.output_root / "oracle_frame_geometry_sequences.jsonl"
        ...
        for row in rows:
            ...
            write_jsonl_row(
                manifest_handle,
                {
                    ...
                    "oracle_frame_prefix_length": row.get("oracle_frame_prefix_length"),
    ...
    print(
        f"tokenized oracle-frame geometry samples={summary['sample_count']} "
        f"sequences={summary['written_oracle_frame_geometry']} "
