...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Attach residual-corrected retrieved-layout frames and generated local geometry "
...
def main() -> None:
        ...
        for node_index, node in enumerate(graph.get("nodes", []) or []):
            ...
            if geometry_ref:
                ...
                if retrieved_frame is None:
                    ...
                    output_node["retrieved_residual_frame_geometry_error"] = "missing retrieved frame"
                else:
                    request_total += 1
                    sample_request += 1
                    try:
                ...
                if (
                    ...
                    print(f"retrieved_residual_frame_topology_geometry_request {request_total}")
    ...
    summary = {
        "format": "maskgen_retrieved_residual_layout_oracle_frame_geometry_topology_attach_summary_v1",
    ...
    print(
        f"attached retrieved-residual-layout generated topology geometry samples={summary['output_count']} "
