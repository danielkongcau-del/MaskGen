...
from partition_gen.manual_relative_layout_ar import build_relative_layout_sequence_rows  # noqa: E402
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Tokenize topology-conditioned manual relative layout sequences.")
...
def main() -> None:
    ...
    rows, summary = build_relative_layout_sequence_rows(
        args.split_root,
        config=config,
        vocab=vocab,
    ...
    sequences_path = args.output_root / "relative_layout_sequences.jsonl"
    ...
    print(
        f"tokenized relative layout samples={summary['sample_count']} "
