...
def main() -> None:
    ...
    payload = build_manual_rule_explanation_payload(
        ...
        config=ManualRuleExplainerConfig(
            ...
            include_soft_rules=args.include_soft_rules,
            split_support_by_connected_components=not args.disable_support_component_split,
            split_divider_by_connected_components=not args.disable_divider_component_split,
