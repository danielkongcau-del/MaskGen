...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Attach relative-layout-AR predicted frames and placeholder shapes to topology samples.")
...
def main() -> None:
    ...
    summary = {
        "format": "maskgen_relative_layout_ar_topology_attach_summary_v1",
    ...
    print(
        f"attached relative-layout-ar topology samples={summary['output_count']} layout_valid={valid_layout_count} "
